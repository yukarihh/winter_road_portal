  ...
  return (
    <div className="firstBannerContainer">
      <div className="firstBannerImageContainer">
        <img className="firstBannerImage" src={titleImage} alt="firstBanner"/>
      </div>
      ...
      <div className="firstBannerText">
        <Typography style={{ color: "#0E2959" }}>
          ...
          Northern communities who rely on these networks for receiving
          essential goods and services during winter season. The public and
          private transportation sectors also rely on winter road networks for
          their operations. A warming climate has created a shorter winter road
          season, unreliable road conditions, and safety concerns.
        </Typography>
      </div>
    </div>
  );
